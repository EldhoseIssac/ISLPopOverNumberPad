#
#  Be sure to run `pod spec lint ISLPopOverNumberPad.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "EldhoseIssac" => "eldhose.i@gmail.com" }
  # s.authors          = { "EldhoseIssac" => "eldhose.i@gmail.com", "other author" => "email@address.com" }
  # s.author           = 'EldhoseIssac', 'other author'
  # s.social_media_url = "http://twitter.com/EldhoseIssac"
